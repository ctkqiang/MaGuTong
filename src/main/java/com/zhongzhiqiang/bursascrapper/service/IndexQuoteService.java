package com.zhongzhiqiang.bursascrapper.service;

import com.zhongzhiqiang.bursascrapper.model.IndexQuote;
import com.zhongzhiqiang.bursascrapper.repository.IndexQuoteRepository;
import com.zhongzhiqiang.bursascrapper.service.scraper.PageFetcher;
import com.zhongzhiqiang.bursascrapper.service.scraper.parser.IndexParser;
 ...
 *
 * <p>编排 "抓取 -> 解析 -> 持久化" 全流程，对应原 Python 版本 {@code dm_indices.process_indices}
